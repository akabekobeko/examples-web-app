...
window.onload = () => {
  const props = {
    ...
    content: {
      items: [
        ...
        {
          title: 'It showed a lady fitted out...',
        ...
        {
          title: 'However hard he threw himself onto his right',
          text: 'However hard he threw himself onto his right, he always rolled back to where he was. He must have tried it a hundred times, shut his eyes so that he wouldn\'t have to look at the floundering legs, and only stopped when he began to feel a mild, dull pain there that he had never felt before. "Oh, God", he thought, "what a strenuous career it is that I\'ve chosen! Travelling day in and day out.'
        },
        {
          title: 'Doing business like this...',
  ...
  ReactDOM.render(<App {...props} />, document.querySelector('.main'))
}
