...
var main = require( './vm/main.jsx' )( '.content' );
main.load();



},{"./vm/main.jsx":6}],2:[function(require,module,exports){
(function (global){
/**
 * React v0.12.2
 */
...
var MusicList = React.createClass( {displayName: "MusicList",
    ...
    render: function() {
        var items = this.props.musics.map( function( music ) {
            return (
                React.createElement("tr", {key: music.id, onClick: this.onSelect.bind( this, music)}, 
                    React.createElement("td", null, music.title), 
                    React.createElement("td", null, music.artist), 
                    React.createElement("td", null, music.album), 
                    React.createElement("td", null, music.genre)
                )
            );
...
},{"./../../../bower_components/react/react.js":2}],6:[function(require,module,exports){
var React   = require( "./../../../bower_components/react/react.js" );
...
},{"../model/musics.js":3,"./../../../bower_components/react/react.js":2,"./editor.jsx":4,"./list.jsx":5}]},{},[1])
